  ...
  return (
    <div className="mb-20">
      ...
      <p className="mx-auto leading-relaxed text-base mb-4 text-justify">
        ...
        Sequi alias tempore quis est blanditiis nam ex quia dolore rerum non eum
      ...
      <p className="mx-auto leading-relaxed text-base mb-4 text-justify">
        ...
        excepturi vero doloribus fuga inventore nam dolorem aspernatur
        asperiores commodi esse praesentium dolor assumenda dolore est impedit
        illum earum, ullam mollitia blanditiis vel porro? Nam ipsum neque cumque
        sed, alias aperiam dolores exercitationem laboriosam, nemo cum officia
        pariatur voluptates iste quos corrupti, quia assumenda eius? Atque dicta
        in quos aut consequatur voluptate!
      </p>
    </div>
  );
};
